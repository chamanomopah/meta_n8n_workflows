...
2. cria os commands com base no plan. cada novo workflow precisa ser criado na pasta C:\.n8n_workflows\projects\[#numero daordemdoworkflow]-[nome_do_workflow]\ dentro com readme.md (contexto do workflow) e workflow.json  e o .claude\commands\*.md
